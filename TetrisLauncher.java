 ...
 * Programemd on January 16th, 2018
 * This program is responsible for handling much of the game logic and reading user input.
 */
...
public class TetrisLauncher extends JFrame {
 ...
 private TetrisLauncher() {
   ...
   */
  this.board = new GamePanel(this);
  this.side = new StatsPanel(this);
  this.instruction = new InstructionPanel(this);
 ...
 private void startGame() {
  ...
  this.gameSpeed = 1.0f;
    ...
    /*
   *Start the background music and loop as the user plays the game
   */
 ...
 private void rotatePiece(int newRotation) {
  ...
  } else if(currentCol + currentType.getDimension() - right >= GamePanel.COL_COUNT) {
   newColumn -= (currentCol + currentType.getDimension() - right) - GamePanel.COL_COUNT + 1;
  }
  ...
  } else if(currentRow + currentType.getDimension() - bottom >= GamePanel.ROW_COUNT) {
   newRow -= (currentRow + currentType.getDimension() - bottom) - GamePanel.ROW_COUNT + 1;
  }
 ...
 public static void main(String[] args) {
  TetrisLauncher tetris = new TetrisLauncher();
  tetris.startGame();
 }
