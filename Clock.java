 ...
 * Tracks the number of cycles that have elapsed over time
 */
public class Clock {
 ...
 /**
  * Checks to see if a cycle has elapsed for this clock yet. If so, the number of elapsed cycles will be decremented by one.
 ...
 /**
  * Checks to see if a cycle has elapsed for this clock yet. Unlike hasElapsedCycle}, the number of cycles will not be decremented
 ...
 /**
  * Calculates the current time in milliseconds using the computer's clock. This is much more reliable
